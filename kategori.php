            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <input class="form-control" type="text" placeholder="enter keywords!" aria-label="Enter search term..." aria-describedby="button-search" />
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body tentang">Welcome to DramaKoreaSpot, your ultimate source for all things related to Korean dramas! Our blog is dedicated to providing you with the latest 
                            information, detailed reviews, and timely updates on your favorite K-dramas. Whether you're a long-time fan or new to the world of Korean entertainment, DramaKoreaSpot is here to guide you through the best dramas, introduce you to the stars, and keep you informed about the latest trends and news. Join our community of drama 
                            enthusiasts and dive into the captivating world of Korean storytelling with us!
                        </div>
                    </div>
                </div>
            </div>
